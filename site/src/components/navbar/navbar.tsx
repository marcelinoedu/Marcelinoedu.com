...
import imageBrazil from "/src/assets/imgs/brazil-svgrepo-com.svg";
import imageUs from "/src/assets/imgs/united-states-of-america-svgrepo-com.svg"
interface NavProps {
  toggleTheme: () => void;
  setText: () => void;
  lightTheme: boolean;
...
function Navbar({toggleTheme, setText, cursorToggle, lightTheme, textLanguage}:NavProps) {
  const iconBrasil = (
    <img width="100%"
    height="100%" src={imageBrazil} alt="Brazil" />
  )
  const iconUs = (
    <img  width="100%"
    height="100% "src={imageUs} alt="USA" />
  )
  const iconMoon = (
    <svg
      id="icon-moon"
